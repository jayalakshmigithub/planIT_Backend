...
userRoutes.post('/projects/remove-member',verifyToken,checkBlocked,removeMembers)
userRoutes.post('/projects/delete-project',verifyToken,checkBlocked,deleteProject)
